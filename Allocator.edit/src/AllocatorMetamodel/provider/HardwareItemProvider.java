...
/**
 * This is the item provider adapter for a {@link AllocatorMetamodel.Hardware} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hardware_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hardware_Name_feature", "_UI_Hardware_type"),
				 AllocatorMetamodelPackage.Literals.HARDWARE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.HARDWARE__HW_NODES);
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.HARDWARE__HW_LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.HARDWARE__HW_NODES,
				 AllocatorMetamodelFactory.eINSTANCE.createHWNode()));

		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.HARDWARE__HW_LINKS,
				 AllocatorMetamodelFactory.eINSTANCE.createHWLink()));
	}
