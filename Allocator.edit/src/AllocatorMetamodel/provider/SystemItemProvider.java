...
/**
 * This is the item provider adapter for a {@link AllocatorMetamodel.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AllocatorMetamodelPackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.SYSTEM__PLATFORMS);
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.SYSTEM__SOFTWARES);
		}
	...
	public String getText(Object object) {
		String label = ((AllocatorMetamodel.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AllocatorMetamodel.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.SYSTEM__PLATFORMS,
				 AllocatorMetamodelFactory.eINSTANCE.createHardware()));

		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.SYSTEM__SOFTWARES,
				 AllocatorMetamodelFactory.eINSTANCE.createSoftware()));
	}
