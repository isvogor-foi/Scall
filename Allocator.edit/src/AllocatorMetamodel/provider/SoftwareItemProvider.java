...
/**
 * This is the item provider adapter for a {@link AllocatorMetamodel.Software} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SoftwareItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AllocatorMetamodelPackage.Literals.SOFTWARE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.SOFTWARE__SW_NODES);
			childrenFeatures.add(AllocatorMetamodelPackage.Literals.SOFTWARE__SW_LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.SOFTWARE__SW_NODES,
				 AllocatorMetamodelFactory.eINSTANCE.createSWNode()));

		newChildDescriptors.add
			(createChildParameter
				(AllocatorMetamodelPackage.Literals.SOFTWARE__SW_LINKS,
				 AllocatorMetamodelFactory.eINSTANCE.createSWLink()));
	}
