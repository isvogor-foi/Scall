 ...
 * @generated
 */
public class ResourceValueEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceValueEditPart(View view) {
		super(view);
	}
			...
			parser = AllocatorMetamodel.diagram.providers.Allocator_metamodelParserProvider
					.getParser(
							...
							AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
									.getType(AllocatorMetamodel.diagram.edit.parts.ResourceValueEditPart.VISUAL_ID));
		}
		return parser;
	}
