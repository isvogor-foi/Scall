...
public class ResourceEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new AllocatorMetamodel.diagram.edit.policies.ResourceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AllocatorMetamodel.diagram.edit.parts.ResourceNameEditPart) {
			((AllocatorMetamodel.diagram.edit.parts.ResourceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceNameFigure());
			return true;
		}
		if (childEditPart instanceof AllocatorMetamodel.diagram.edit.parts.ResourceUnitEditPart) {
			((AllocatorMetamodel.diagram.edit.parts.ResourceUnitEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureResourceUnitFigure());
			return true;
		}
		if (childEditPart instanceof AllocatorMetamodel.diagram.edit.parts.ResourceValueEditPart) {
			((AllocatorMetamodel.diagram.edit.parts.ResourceValueEditPart) childEditPart)
