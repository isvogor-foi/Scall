 ...
 * @generated
 */
public class ResourceUnitEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceUnitEditPart(View view) {
		super(view);
	}
			...
			parser = AllocatorMetamodel.diagram.providers.Allocator_metamodelParserProvider
					.getParser(
							...
							AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
									.getType(AllocatorMetamodel.diagram.edit.parts.ResourceUnitEditPart.VISUAL_ID));
		}
		return parser;
	}
