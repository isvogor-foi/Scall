 ...
 * @generated
 */
public class ResourceValue2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceValue2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new AllocatorMetamodel.diagram.edit.policies.Allocator_metamodelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AllocatorMetamodel.diagram.providers.Allocator_metamodelParserProvider
					.getParser(
							...
							AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
									.getType(AllocatorMetamodel.diagram.edit.parts.ResourceValue2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					AllocatorMetamodel.diagram.edit.parts.Allocator_metamodelEditPartFactory
