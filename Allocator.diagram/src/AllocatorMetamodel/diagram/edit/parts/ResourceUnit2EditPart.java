 ...
 * @generated
 */
public class ResourceUnit2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResourceUnit2EditPart(View view) {
		super(view);
	}
			...
			parser = AllocatorMetamodel.diagram.providers.Allocator_metamodelParserProvider
					.getParser(
							...
							AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
									.getType(AllocatorMetamodel.diagram.edit.parts.ResourceUnit2EditPart.VISUAL_ID));
		}
		return parser;
	}
