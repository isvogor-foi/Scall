 ...
 * @generated
 */
public class HWNodeHWResourceCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getHWNodeHWResourceCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AllocatorMetamodel.diagram.edit.parts.Resource2EditPart.VISUAL_ID == AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getHWNodeHWResourceCompartment_7004SemanticChildren((View) getHost()
						.getModel());
