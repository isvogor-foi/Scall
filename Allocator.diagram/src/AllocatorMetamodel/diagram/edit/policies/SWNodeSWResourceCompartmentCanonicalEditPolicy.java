 ...
 * @generated
 */
public class SWNodeSWResourceCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getSWNodeSWResourceCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AllocatorMetamodel.diagram.edit.parts.ResourceEditPart.VISUAL_ID == AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getSWNodeSWResourceCompartment_7003SemanticChildren((View) getHost()
						.getModel());
