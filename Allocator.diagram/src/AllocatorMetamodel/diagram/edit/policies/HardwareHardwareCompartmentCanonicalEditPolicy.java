 ...
 * @generated
 */
public class HardwareHardwareCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getHardwareHardwareCompartment_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return AllocatorMetamodel.diagram.edit.parts.HWNodeEditPart.VISUAL_ID == AllocatorMetamodel.diagram.part.Allocator_metamodelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<AllocatorMetamodel.diagram.part.Allocator_metamodelNodeDescriptor> childDescriptors = AllocatorMetamodel.diagram.part.Allocator_metamodelDiagramUpdater
				.getHardwareHardwareCompartment_7002SemanticChildren((View) getHost()
						.getModel());
