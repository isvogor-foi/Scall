 ...
 * @generated
 */
public class Allocator_metamodelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Allocator_metamodelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof AllocatorMetamodel.diagram.navigator.Allocator_metamodelDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((AllocatorMetamodel.diagram.navigator.Allocator_metamodelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new AllocatorMetamodel.diagram.navigator.Allocator_metamodelDomainNavigatorItem(
